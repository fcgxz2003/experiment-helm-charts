...
output_file="../fig11_output/50pod_500M_default_epoch4.txt"
...
touch ../fig11_output/50pod_500M_default_epoch4.txt
...
command_delete() {
  kubectl exec -it $pod-$1 -c peer -n $namespace -- rm -rf 500M.bin?x=1001
}
