...
output_file="../fig11_output/50pod_1G_default_epoch3.txt"
...
touch ../fig11_output/50pod_1G_default_epoch3.txt
...
command_delete() {
  kubectl exec -it $pod-$1 -c peer -n $namespace -- rm -rf 1G.bin?x=1001
}
