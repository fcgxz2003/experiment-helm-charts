...
output_file="../fig11_output/50pod_10G_random_epoch3.txt"
...
touch ../fig11_output/50pod_10G_random_epoch3.txt
...
command_delete() {
  kubectl exec -it $pod-$1 -c peer -n $namespace -- rm -rf 10G.bin?x=1002
}
