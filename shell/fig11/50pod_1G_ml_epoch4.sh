...
output_file="../fig11_output/50pod_1G_ml_epoch4.txt"

tmp_dir=$(mktemp -d)

pod="dragonfly-peer"
minio_address=$MINIO_ADDRESS
model="http://$minio_address/models/1G.bin"
container="peer"
namespace="dragonfly-system"

mkdir -p ../fig11_output
touch ../fig11_output/50pod_1G_ml_epoch4.txt
...
command_delete() {
  kubectl exec -it $pod-$1 -c peer -n $namespace -- rm -rf 1G.bin
}
