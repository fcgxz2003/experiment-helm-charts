...
for i in $(seq 0 49);do
    kubectl exec -it $pod-$i -c peer -n $namespace -- rm -rf 10G.bin?x=1305 &
done
...
for i in $(seq 0 59);do
    kubectl exec -it $pod-$i -c peer -n $namespace -- rm -rf 10G.bin?x=1306 &
done
...
for i in $(seq 0 79);do
    kubectl exec -it $pod-$i -c peer -n $namespace -- rm -rf 10G.bin?x=1307 &
done
